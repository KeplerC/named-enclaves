 ...
 */
#ifndef EDGER8R_ATTESTATION_U_H
#define EDGER8R_ATTESTATION_U_H
...
/**** ECALL prototypes. ****/
oe_result_t get_enclave_format_settings(
    oe_enclave_t* enclave,
    int* _retval,
    const oe_uuid_t* format_id,
    format_settings_t* format_settings);

oe_result_t get_evidence_with_public_key(
    oe_enclave_t* enclave,
    int* _retval,
    const oe_uuid_t* format_id,
    format_settings_t* format_settings,
...
oe_result_t verify_evidence_and_set_public_key(
    oe_enclave_t* enclave,
    int* _retval,
    const oe_uuid_t* format_id,
    pem_key_t* pem_key,
...
oe_result_t process_encrypted_message(
    oe_enclave_t* enclave,
    int* _retval,
    message_t* message);
