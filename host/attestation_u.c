...
enum
{
    attestation_fcn_id_get_enclave_format_settings = 0,
    attestation_fcn_id_get_evidence_with_public_key = 1,
    attestation_fcn_id_verify_evidence_and_set_public_key = 2,
    attestation_fcn_id_generate_encrypted_message = 3,
    attestation_fcn_id_process_encrypted_message = 4,
    attestation_fcn_id_oe_verify_report_ecall = 5,
    attestation_fcn_id_oe_get_sgx_report_ecall = 6,
    attestation_fcn_id_oe_get_report_v2_ecall = 7,
    attestation_fcn_id_oe_verify_local_report_ecall = 8,
    attestation_fcn_id_oe_sgx_init_context_switchless_ecall = 9,
    attestation_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 10,
...
typedef struct _get_enclave_format_settings_args_t
{
...
} get_enclave_format_settings_args_t;

typedef struct _get_evidence_with_public_key_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    format_settings_t* format_settings;
    pem_key_t* pem_key;
    evidence_t* evidence_buffer;
} get_evidence_with_public_key_args_t;

typedef struct _verify_evidence_and_set_public_key_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    pem_key_t* pem_key;
    evidence_t* evidence;
} verify_evidence_and_set_public_key_args_t;
...
typedef struct _process_encrypted_message_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    message_t* message;
} process_encrypted_message_args_t;
...
oe_result_t attestation_get_enclave_format_settings(
    ...
    format_settings_t* format_settings)
{
    ...
    /* Marshalling struct. */
    get_enclave_format_settings_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.format_settings = (format_settings_t*)format_settings;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(get_enclave_format_settings_args_t));
    if (format_id)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(oe_uuid_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(get_enclave_format_settings_args_t));
    if (format_settings)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(format_settings_t));
    ...
    _pargs_in = (get_enclave_format_settings_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_get_enclave_format_settings].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (get_enclave_format_settings_args_t*)_output_buffer;
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(format_settings, 1, sizeof(format_settings_t));
    if (format_settings && format_settings->buffer)
        OE_SET_DEEPCOPY_OUT_PARAM(format_settings->buffer, 1, format_settings->size, uint8_t*);
...
OE_WEAK_ALIAS(attestation_get_enclave_format_settings, get_enclave_format_settings);

oe_result_t attestation_get_evidence_with_public_key(
    oe_enclave_t* enclave,
    int* _retval,
    const oe_uuid_t* format_id,
    format_settings_t* format_settings,
    ...
    evidence_t* evidence_buffer)
{
    ...
    /* Marshalling struct. */
    get_evidence_with_public_key_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    _args.format_id = (oe_uuid_t*)format_id;
    _args.format_settings = (format_settings_t*)format_settings;
    _args.pem_key = (pem_key_t*)pem_key;
    _args.evidence_buffer = (evidence_t*)evidence_buffer;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(get_evidence_with_public_key_args_t));
    if (format_id)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(oe_uuid_t));
    if (format_settings)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(format_settings_t));
    if (format_settings && format_settings->buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.format_settings->size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(get_evidence_with_public_key_args_t));
    if (pem_key)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(pem_key_t));
    if (evidence_buffer)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(evidence_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (get_evidence_with_public_key_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (format_id)
        OE_WRITE_IN_PARAM(format_id, 1, sizeof(oe_uuid_t), oe_uuid_t*);
    if (format_settings)
        OE_WRITE_IN_PARAM(format_settings, 1, sizeof(format_settings_t), format_settings_t*);
    if (format_settings && format_settings->buffer)
        OE_WRITE_IN_PARAM(format_settings->buffer, 1, _args.format_settings->size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_get_evidence_with_public_key].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (get_evidence_with_public_key_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(pem_key, 1, sizeof(pem_key_t));
    if (pem_key && pem_key->buffer)
        OE_SET_DEEPCOPY_OUT_PARAM(pem_key->buffer, 1, pem_key->size, uint8_t*);
    OE_READ_OUT_PARAM(evidence_buffer, 1, sizeof(evidence_t));
    if (evidence_buffer && evidence_buffer->buffer)
        OE_SET_DEEPCOPY_OUT_PARAM(evidence_buffer->buffer, 1, evidence_buffer->size, uint8_t*);
...
OE_WEAK_ALIAS(attestation_get_evidence_with_public_key, get_evidence_with_public_key);

oe_result_t attestation_verify_evidence_and_set_public_key(
    oe_enclave_t* enclave,
    int* _retval,
    const oe_uuid_t* format_id,
    pem_key_t* pem_key,
    evidence_t* evidence)
{
    ...
    /* Marshalling struct. */
    verify_evidence_and_set_public_key_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    _args.format_id = (oe_uuid_t*)format_id;
    _args.pem_key = (pem_key_t*)pem_key;
    _args.evidence = (evidence_t*)evidence;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(verify_evidence_and_set_public_key_args_t));
    if (format_id)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(oe_uuid_t));
    if (pem_key)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(pem_key_t));
    if (pem_key && pem_key->buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.pem_key->size);
    if (evidence)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(evidence_t));
    if (evidence && evidence->buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.evidence->size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(verify_evidence_and_set_public_key_args_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (verify_evidence_and_set_public_key_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (format_id)
        OE_WRITE_IN_PARAM(format_id, 1, sizeof(oe_uuid_t), oe_uuid_t*);
    if (pem_key)
        OE_WRITE_IN_PARAM(pem_key, 1, sizeof(pem_key_t), pem_key_t*);
    if (pem_key && pem_key->buffer)
        OE_WRITE_IN_PARAM(pem_key->buffer, 1, _args.pem_key->size, uint8_t*);
    if (evidence)
        OE_WRITE_IN_PARAM(evidence, 1, sizeof(evidence_t), evidence_t*);
    if (evidence && evidence->buffer)
        OE_WRITE_IN_PARAM(evidence->buffer, 1, _args.evidence->size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_verify_evidence_and_set_public_key].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (verify_evidence_and_set_public_key_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(attestation_verify_evidence_and_set_public_key, verify_evidence_and_set_public_key);

oe_result_t attestation_generate_encrypted_message(
    oe_enclave_t* enclave,
    int* _retval,
    message_t* message)
{
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.message = (message_t*)message;
    ...
    if (message)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(message_t));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_generate_encrypted_message].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(message, 1, sizeof(message_t));
    if (message && message->data)
        OE_SET_DEEPCOPY_OUT_PARAM(message->data, 1, message->size, uint8_t*);
...
OE_WEAK_ALIAS(attestation_generate_encrypted_message, generate_encrypted_message);

oe_result_t attestation_process_encrypted_message(
    oe_enclave_t* enclave,
    int* _retval,
    message_t* message)
{
    ...
    /* Marshalling struct. */
    process_encrypted_message_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(process_encrypted_message_args_t));
    if (message)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(message_t));
    if (message && message->data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.message->size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(process_encrypted_message_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (process_encrypted_message_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (message)
        OE_WRITE_IN_PARAM(message, 1, sizeof(message_t), message_t*);
    if (message && message->data)
        OE_WRITE_IN_PARAM(message->data, 1, _args.message->size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_process_encrypted_message].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (process_encrypted_message_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(attestation_process_encrypted_message, process_encrypted_message);
...
enum
{
    ...
    attestation_fcn_id_oe_get_supported_attester_format_ids_ocall = 73,
    attestation_fcn_id_oe_get_qetarget_info_ocall = 74,
    attestation_fcn_id_oe_get_quote_ocall = 75,
    attestation_fcn_id_oe_get_quote_verification_collateral_ocall = 76,
    attestation_fcn_id_oe_verify_quote_ocall = 77,
    attestation_fcn_id_oe_sgx_get_cpuid_table_ocall = 78,
    attestation_fcn_id_oe_sgx_backtrace_symbols_ocall = 79,
    attestation_fcn_id_oe_sgx_thread_wake_wait_ocall = 80,
    attestation_fcn_id_oe_sgx_wake_switchless_worker_ocall = 81,
    attestation_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 82,
