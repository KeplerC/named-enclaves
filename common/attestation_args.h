 ...
 */
#ifndef EDGER8R_ATTESTATION_ARGS_H
#define EDGER8R_ATTESTATION_ARGS_H
...
#ifndef EDGER8R_STRUCT_FORMAT_SETTINGS_T
#define EDGER8R_STRUCT_FORMAT_SETTINGS_T
typedef struct format_settings_t
{
    uint8_t* buffer;
    size_t size;
} format_settings_t;
...
#ifndef EDGER8R_STRUCT_PEM_KEY_T
#define EDGER8R_STRUCT_PEM_KEY_T
typedef struct pem_key_t
{
    uint8_t* buffer;
    size_t size;
} pem_key_t;
...
#ifndef EDGER8R_STRUCT_EVIDENCE_T
#define EDGER8R_STRUCT_EVIDENCE_T
typedef struct evidence_t
{
    uint8_t* buffer;
    size_t size;
} evidence_t;
...
#ifndef EDGER8R_STRUCT_MESSAGE_T
#define EDGER8R_STRUCT_MESSAGE_T
...
#endif // EDGER8R_ATTESTATION_ARGS_H
